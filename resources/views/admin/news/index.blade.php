        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('admin.news.create') }}" class="btn btn-info">Create News</a>
                </div>
            </div>
                                        ...
                                        <table class="table table-striped projects">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.news.edit', $new->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i>  edit</a>
