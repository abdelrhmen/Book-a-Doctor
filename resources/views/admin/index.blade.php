                    ...
                    <div class="row match-height">
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-success GreenColor">
                                <div class="inner" style="color:white!important">
                                    <h3 id="txtAllSessionCount" class="">{{$doctor_count}}</h3>
                                    <p>Total Doctors</p>
                                </div>
                                <div class="icon">
                                    <i class="font-medium-5 fa fa-user-md"></i>
                                </div>
                                <a href="{{ route('admin.doctor.index' )}}" onclick="LoadAllSessions()" class="small-box-footer"
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-primary">
                                <div class="inner" style="color:white!important">
                                    <h3 id="txtAllSessionCount" class="">{{$user_count}}</h3>
                                    <p>Total Users</p>
                                </div>
                                <div class="icon">
                                    <i class="fa fa-stethoscope font-medium-5"></i>
                                </div>
                                <a href="{{ route('admin.user.index' )}}" onclick="LoadAllSessions()" class="small-box-footer"
                                   style="color: #fff!important;">Reload
                                    <i class="fas fa-sync-alt"></i>
                                </a>
                            </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-danger">
                                ...
                                <a href="{{ route('admin.appointment.index' )}}" onclick="LoadAllSessions()" class="small-box-footer"
                                   style="color: #fff!important;">Reload
                                    <i class="fas fa-sync-alt"></i>
                                </a>
                            </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-warning">
                                <div class="inner" style="color:white!important">
                                    <h3 id="txtAllSessionCount" class="">{{$message_count}}</h3>
                                    <p>Total Messages</p>
                                </div>
                                <div class="icon">
                                    <i class="fa fa-stethoscope font-medium-5"></i>
                                </div>
                                <a href="{{ route('admin.message.index' )}}" onclick="LoadAllSessions()" class="small-box-footer"
                                   style="color: #fff!important;">Reload
                                    <i class="fas fa-sync-alt"></i>
                                </a>
                            </div>
